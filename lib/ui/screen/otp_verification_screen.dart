  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: Center(
          child: GetBuilder<UserAuthController>(builder: (uAuthController) {
            return Column(
              ...
              children: [
                ...
                uAuthController.otpVerificationInProgress
                    ...
                    : SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            final bool response =
                                await uAuthController.otpVerification(
                                    widget.email, otpTextEditController.text);
                ...
                RichText(
                  text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text:
                                ' ${uAuthController.secondCount.toString()} Second',
                ...
                TextButton(
                    onPressed: () async {
                      final bool response =
                          await uAuthController.emailVerification(widget.email);
